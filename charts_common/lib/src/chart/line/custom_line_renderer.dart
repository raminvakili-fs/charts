...
class CustomLineRenderer<D> extends BaseCartesianRenderer<D> {
...
@visibleForTesting
class CustomLineRendererTester<D> {
  final CustomLineRenderer<D> renderer;

  CustomLineRendererTester(this.renderer);
